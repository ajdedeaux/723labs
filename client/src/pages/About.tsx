...
export default function About() {
  return (
    <div className="min-h-screen bg-black text-white font-sans selection:bg-white selection:text-black">
      ...
      <section className="pt-24 md:pt-40 pb-16 md:pb-20 container mx-auto px-6 relative">
        ...
        >
          ...
          <p className="text-lg md:text-xl text-white/50 font-mono tracking-widest uppercase pl-2 border-l border-white/20">The 723 Labs Story</p>
        </motion.div>
      </section>

      <section className="pb-16 md:pb-32 container mx-auto px-6 max-w-4xl">
        <div className="prose prose-invert prose-lg max-w-none">
          <motion.div
             ...
             transition={{ duration: 0.8 }}
          >
            <p className="text-xl md:text-4xl leading-relaxed text-white font-light mb-12 md:mb-16">
          ...
          <div className="space-y-8 text-white/70 font-light leading-relaxed text-base md:text-lg pl-6 md:pl-8 border-l border-white/10">
            <p>
          ...
          <div className="mt-16 md:mt-20 grid md:grid-cols-2 gap-12 md:gap-16">
            <div>
              <h3 className="text-white font-heading text-2xl md:text-3xl mb-6">How I Learned</h3>
            ...
            <div>
              <h3 className="text-white font-heading text-2xl md:text-3xl mb-6">Why 723 Labs?</h3>
              <p className="text-white/60 font-light leading-relaxed">
          ...
          <motion.div 
            ...
            viewport={{ once: true }}
            className="p-8 md:p-12 border border-white/10 bg-white/[0.02] rounded-2xl my-16 md:my-20 relative overflow-hidden"
          >
            <div className="absolute top-0 left-0 w-1 h-full bg-white" />
            <p className="text-xl md:text-2xl italic text-white/90 font-heading leading-relaxed">
          ...
          <h3 className="text-white font-heading text-2xl md:text-3xl mt-16 md:mt-20 mb-8">Why Clients Trust Me</h3>
          <p className="text-white/60 font-light leading-relaxed text-base md:text-lg mb-12">
      ...
      <section className="py-16 md:py-40 text-center relative overflow-hidden bg-white text-black">
        ...
        <div className="container mx-auto px-6 relative z-10">
          <h2 className="text-4xl md:text-7xl font-heading font-bold mb-10 tracking-tighter text-black">Ready to Build?</h2>
          <Link href="/contact">
